        	...
        	<div id="contents_in">
				<div class="row">
					<div class="col-md-8">
						<div id="contents_in_left">            	    
							<div id="TextD" style="margin:0;">
								...
								<div id="TheText">
									<p class="Pd1"><b>EMAIL NEWSLETTER MANAGEMENT</b></p>
								   <!-- <p class="Pd2"><a href="about.php">Read More</a></p>	-->
									<p class="clear"></p>
									<p class="Pd3">60% of businesses say email marketing is their most effective and consistent channel in terms of revenue generation.<br>
											Are you tapping into this huge opportunity?<br><br>
												<strong>Some of the tasks I'll perform for you include:</strong><br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Build your email list from scratch.<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Send out your articles via email (weekly, monthly, etc.)<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Develop a customized email marketing strategy that works for you.<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Announce your products, services, or upcoming sales<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Set up Autoresponders (Mailchimp, Convert Kit)<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Identify & clean out non-responsive subscribers<br><br>
											</p>
											
							<p class="Pd2"><a style="color:#fff" href="scheduleemail">Schedule A Call</a></p><br><br>
								</div><!--TheText-->
								<div class="clear"></div>
							</div><!--TextD-->
					...
					<div class="col-md-4">						 
                        ...
                        <p class="clear"></p>
                        <div id="SubsLinks">
                            <p style="text-align:left; background:#e6e6e6;  border-bottom-right-radius:30px; padding:10px 20px; line-height:24px; font-weight:bold;">
                                va@jacehr.com
                            </p>
                        </div>
