					...
					<div class="col-md-8">
						<div id="contents_in_left">            	    
							<div id="TextD" style="margin:0;">
								<br>
								<div id="imag"><img src="images/who.png" height="148" width="150" /></div>
								<div id="TheText">
									<p class="Pd1"><b>WHY WORK WITH ME?</b></p>
								   <!-- <p class="Pd2"><a href="about.php">Read More</a></p>	-->
									...
									<p class="Pd3" style="line-height:40px;">
										...
										(2) Personalized Service<br>
										
										(3) Accountability & Support<br>
										
										(4) High Quality Output<br>
										
										(5) Timely delivery<br>
										
										(6) Excellent Communication<br>
										
										(7) Understanding & Compassionate<br>
										
										(8) Regular Check-ins<br>
										
										(9) I don't promise what I cannot deliver<br>
										
										(10) Pocket Friendly<br><br>
