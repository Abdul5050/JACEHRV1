				...
				<div class="row">
					<div class="col-md-8">
						<div id="contents_in_left">            	    
							<div id="TextD" style="margin:0;">
								...
								<div id="TheText">
									<p class="Pd1"><b>WEBSITE DESIGN & MAINTENANCE</b></p>
								   <!-- <p class="Pd2"><a href="about.php">Read More</a></p>	-->
									<p class="clear"></p>
									<p class="Pd3">Get a website design that does not just focus on beautiful graphics -- but combines this with real-life business results that you can measure.<br><br>
											Come to think of it, if your website is only fancy-looking but doesn’t bring you any sales, what’s the essence?<br><br>
											But then again, why choose between beauty and functionality when you can have the best of both worlds in one single web design?<br><br>
												<strong>Each new web design project includes:</strong><br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Unlimited number of pages & call-to-action buttons <br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Mobile responsive design<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Blog setup & design<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Google Analytics Integration<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. In-built Search Engine Optimization (SEO)<br><br>
												
												
									</p>
											
							<p class="Pd2"><a style="color:#fff" href="scheduleweb">Schedule A Call</a></p><br><br>
								</div><!--TheText-->
								<div class="clear"></div>
							</div><!--TextD-->
					...
					<div class="col-md-4">						 
						<div id="contents_in_right">
							<p class="Pd11" style="width: 300px;"><b>Website Design - What I can help you with</b></p>
                        <p class="clear"></p>
                        <div id="SubsLinks">
                            <p style="text-align:left; background:#e6e6e6;  border-bottom-right-radius:30px; padding:10px 20px; line-height:33px;">
                                <strong>. Design a brand-new website from scratch.<br><br>. Upload images and content to your website.<br><br>
                                . Make changes, corrections, & updates to an existing website.<br><br>
                                . Optimize your site for Search Engines (SEO).<br><br>
                            </p>
