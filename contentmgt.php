				...
				<div class="row">
					<div class="col-md-8">
						<div id="contents_in_left">            	    
							<div id="TextD" style="margin:0;">
								...
								<div id="TheText">
									<p class="Pd1"><b>CONTENT MANAGEMENT</b></p>
								   <!-- <p class="Pd2"><a href="about.php">Read More</a></p>	-->
									<p class="clear"></p>
									<p class="Pd3">If you're writing tons of articles but no one is reading them, then it's time to get your content in front of more people. <br><br>
											Do you optimize each of your articles using your target keywords? Are those articles being submitted to Google for search engine indexing?<br><br>
												<strong>Some of the tasks I'll perform for you include:</strong><br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Create new content or edit existing articles.<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Optimize your content for search engines using your keywords.<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Share your content across various platforms (blog, social media, Medium.com, LinkedIn, etc.)<br>
												&nbsp;&nbsp;&nbsp;&nbsp;. Setup Search Console and submit your website URLs to Google for Indexing<br><br>
												
									</p>
											
							<p class="Pd2"><a style="color:#fff" href="schedulecontent">Schedule A Call</a></p><br><br>
								</div><!--TheText-->
								<div class="clear"></div>
							</div><!--TextD-->
					...
					<div class="col-md-4">						 
						<div id="contents_in_right">
							<p class="Pd11" style="width: 300px;"><b>Content Mgt. - What I can help you with</b></p>
                        <p class="clear"></p>
                        <div id="SubsLinks">
                            <p style="text-align:left; background:#e6e6e6;  border-bottom-right-radius:30px; padding:10px 20px; line-height:33px;">
                                <strong>. Create new content or edit existing articles.<br><br>. Optimize your content for search engines using your keywords.<br><br>
                                . Share your content across various platforms (blog, social media, Medium.com, LinkedIn, etc.)<br><br>
                                . Setup Search Console and submit your website URLs to Google for Indexing<br><br>
                            </p>
