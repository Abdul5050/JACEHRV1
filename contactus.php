						...
						<div id="contents_in_leftD">
							<div id="TextD" style="margin:0;">
								<div id="TheTextD" style="margin-top:0px;">
									<p style="background-color:#009; width:auto; background:url(images/infoBg.png) no-repeat; font-weight:bold; padding:5px 20px; color:#fff;">Contact Details</p>
									<p class="clear"></p>
									<div id="SubsLinks">
									<p style="line-height:24px;"> Shoot me a quick email.<br><br> Expect a response same day.<br><br>
										<strong>Email: va@jacehr.com </strong>
									</p>
									
									<br><br>
									<a href="schedulecall"><p style="background-color:#009; width:auto; background:url(https://www.jacehr.com/images/infoBg.png) no-repeat; font-weight:bold; padding:5px 20px; color:#fff;">Wanna talk? Click Here.</p></a>
